...
if selected == 'Home':
    ...
    if current_theme == "light":
        image_url1 = 'https://i2.wp.com/blog.indiefolio.com/wp-content/uploads/2015/07/SW_AF_AppleFizz_new.gif?resize=1024%2C633&ssl=1'
    else:
        image_url1 = 'https://raw.githubusercontent.com/tamertinkci/ML4B-Team-7/2963a33d77d69539a55e1445c60a8305edd12d72/assets/applelogolight.gif'

    assert isinstance(image_url1, str), f"Expected image_url1 to be a string, but got {type(image_url1)}"
    ...
    with col2:
        ...
        if current_theme == "light":
            image_url2 = 'https://raw.github.com/tamertinkci/ML4B-Team-7/c8df0db3f7e8e27f9879360dbd216c9276ceea41/assets/GANdark.webp'
        else:
    ...
    with col1:
        current_theme = st.session_state.themes["current_theme"]
        if current_theme == "light":
            image_url3 = 'https://raw.github.com/tamertinkci/ML4B-Team-7/70637eb749311fdc8d378b1d80008b567ede495f/assets/darkimage.gif'
        else:
            image_url3 = 'https://raw.github.com/tamertinkci/ML4B-Team-7/70637eb749311fdc8d378b1d80008b567ede495f/assets/lightimage.gif'

        assert isinstance(image_url3, str), f"Expected image_url3 to be a string, but got {type(image_url3)}"
        st.image(image_url3, width=300, use_column_width=False)
    with col2:
        st.write("")
        st.write("")
        st.write("")
        ...
        st.write("")
        st.write("")
        st.markdown('<h2>Start your journey with our Ai image Generator</h2>', unsafe_allow_html=True)
